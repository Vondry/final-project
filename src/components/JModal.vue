      ...
      <transition name="modal-2" @after-leave="onContentLeave">
        <div v-if="showContent" class="modal-content">
          <div class="modal-header">
            ...
            <div>
              <j-button label="X" small-size @clicked="onCloseClicked"/>
            </div>
          </div>
          ...
          <div class="modal-footer">
            <j-button v-if="okButtonDisplay" :label="okButtonLabel" small-size @clicked="onOkClicked"/>
            <j-button v-if="cancelButtonDisplay" :label="cancelButtonLabel" small-size @clicked="onCancelClicked"/>
          </div>
        </div>
      </transition>
    </div>
