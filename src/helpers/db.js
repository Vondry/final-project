...
export default {
  ...
  // TODO osobne preferuji syntaxi async/await z duvodu citelnosti pred .then.catch
  async post(path, body) {
    try {
      const response = await axios({ method: 'post', url: checkUrl(path), data: body });
      return response.data.data;
    } catch (e) {
      // TODO : ulozil bych radsi error message do logu (v tomto pridade do store), abys vedel, kde to presne selhalo a uzivateli pak muzes ukazat neco vic frendly
